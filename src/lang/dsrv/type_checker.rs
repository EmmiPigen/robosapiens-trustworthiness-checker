...
use super::ast::{
    BoolBinOp, CompBinOp, FloatBinOp, IntBinOp, SBinOp, SExpr, SpannedExpr, StrBinOp,
};
...
mod tests {
    ...
    use crate::lang::dsrv::ast::{NumericalBinOp, SpannedExpr, StrBinOp};
    ...
    fn test_binop_err_diff_types() {
        ...
        let vals = vals_tmp.into_iter().filter(|bin_op: &SpannedExpr| {
            match &bin_op.node {
                crate::lang::dsrv::ast::SExpr::BinOp(left, right, _) => {
